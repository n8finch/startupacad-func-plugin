...
/**
 * N8F Functionality Plugin
 *
 * @package     WPQuickPostDraft\Functionality
 * @since       1.0.0
 * @author      n8finch
...
namespace WPQuickPostDraft\Functionality;

//Add Facebook Pixel
add_action('wp_head', __NAMESPACE__ . '\n8f_add_facebook_pixel' );
...
add_filter( 'show_quiz_continue_buttom_on_fail', __NAMESPACE__ . '\n8f_show_quiz_continue_buttom_on_fail_proc', 10, 2 );
function n8f_show_quiz_continue_buttom_on_fail_proc( $show_button = false, $quiz_id = 0 ) {
	$show_button = true;
	return $show_button;
}

add_filter('learndash_quiz_continue_link', __NAMESPACE__ . '\n8f_change_quiz_complete_link', 5, 2 );
...
// add_shortcode('courses_by_day_button', __NAMESPACE__ . '\n8f_show_learndash_button_based_on_course' );
 ...
 */
add_action( 'wp_head', __NAMESPACE__ . '\n8f_find_last_known_learndash_page' );
add_shortcode( 'n8f-learndash-resume', __NAMESPACE__ . '\n8f_learndash_resume' );
