...
/**
 * N8F RSS Aggregator Plugin
 *
 * @package     WPQuickPostDraft\RSSAgg
 * @since       1.0.0
 * @author      n8finch
...
namespace WPQuickPostDraft\RSSAgg;
...
//Add Short Codes
add_shortcode('n8f-rss-agg-sa', __NAMESPACE__ . '\n8f_sa_rss_shortcode' );
add_shortcode('n8f-rss-agg-tc', __NAMESPACE__ . '\n8f_tc_rss_shortcode' );
add_shortcode('n8f-rss-agg-mash', __NAMESPACE__ . '\n8f_mash_rss_shortcode' );
